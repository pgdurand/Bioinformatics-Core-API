...
public class DSequenceFactoryImplem implements DSequenceFactory {
  public DSequence getSequence(Reader reader, DAlphabet alphabet) {
    ...
    try {
      dSeq = new DSequenceImplem(reader, alphabet);
  ...
  public DSequence getSequence(List<DSequence> seqPart, List<DLocation> locPart, DAlphabet alphabet, int size) {
    DSegmentedSequence dSeq;
    DSequence seq;
    int i, s;

    if (alphabet == null || seqPart == null || locPart == null || seqPart.isEmpty() || locPart.isEmpty()
