...
/**
 * This is a default implementation of DSequenceAlignedFactory.
 * 
 * @author Patrick G. Durand
 */
public class DSequenceAlignedFactoryImplem implements
		DSequenceAlignedFactory {

	public DSequenceAligned getDSequenceAligned(DSequence seq, int startPos) {
		return new DSequenceAlignedImplem(seq, startPos);
	}
