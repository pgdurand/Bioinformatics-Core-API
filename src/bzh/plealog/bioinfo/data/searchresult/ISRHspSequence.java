...
public class ISRHspSequence implements SRHspSequence{
    ...
    public void copy(ISRHspSequence src, boolean shallow){
        ...
        if (!shallow){
	        ...
	        /*ft = src.getFeatures();
	        if (ft!=null)
	        	this.setFeatures((FeatureTable) ft.clone());*/
        	this.setFeatures(src.getFeatures());
        }
    }

    public int getFrom(){return from;}
    public void setFrom(int val){from=val;}

    public int getTo(){return to;}
    public void setTo(int val){to=val;}
    ...
    public FeatureTable getFeatures(){return fTable;}
    ...
    public DSequence getSequence(SRHsp hsp){
    	...
    	if (type==SRHspSequence.TYPE_MIDLINE){
        	...
        	int increment = SRUtils.getIncrement(getFrom(), 
            		getTo(), hsp.getScores().getAlignLen()-getGaps());
